...
/**
 * @Author laobuzhang
 * @Date 2023-06-19 14:16
 * @Description:在凡客商城爬取同城配送的订单数据并调用新增订单接口
 */
@Component
public class SpiderUtil {
    private static String linuxPath;
    @Value("${spider.driver.linux}")
    public void setLinuxPath(String linuxPath){
        SpiderUtil.linuxPath=linuxPath;
    }

    private static String windowsPath;
    @Value("${spider.driver.windows}")
    public void setWindowsPath(String windowsPath){
        SpiderUtil.windowsPath=windowsPath;
    }

    //用来开启爬虫并寻找到对应的网页，完成翻页等功能
    public static void spider() throws IOException, ParseException, InterruptedException {
        // 设置 ChromeDriver 路径
