...
public enum ErrorCode implements BaseErrorInfoInterface {
    ...
    IMAGE_PATH_INVALID("501", "图片路径不合法"),
    FILE_ANALYZE_ERROR("512", "文件解析失败"),
    FILE_EMPTY_ERROR("513", "文件为空"),
    FILE_SIZE_ERROR("513", "文件过大"),
    FILE_TYPE_ERROR("513", "文件格式错误"),
    PAY_ERROR("514", "支付失败"),

    NULL_POINT_EXCEPTION("518", "参数为空"),
    REQUEST_FREQUENT("519", "访问频繁"),
    DOWNLOAD_ERROR("520", "下载出错"),
    UNKNOWN_ERROR("1000", "服务器出错啦"),
    Rider_NOT_EXIST("521", "该用户尚未注册为骑手"),
    RIDER_ORDER_QUANTITY_EXCEED("522", "骑手接单超过上限");
